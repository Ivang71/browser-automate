...
```python
from browser_use import Agent, Browser, ChatBrowserUse, ProxySettings
import asyncio

async def example():
    browser = Browser(
        # use_cloud=True,  # Uncomment to use a stealth browser on Browser Use Cloud
        # Example local overrides for browser settings:
        # is_local=True,
        # headless=False,
        # window_size={"width": 1280, "height": 800},
        # user_agent="Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 "
        #            "(KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36",
        # proxy=ProxySettings(server="http://user:pass@host:8080"),
